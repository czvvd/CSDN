...
import json
import utlis.data_transforms as data_transforms
from utlis.ioo import IO
...
class ViPCDataLoader(Dataset):
    def __init__(self,filepath,data_path,status,pc_input_num=3500,view_align=False,category='all'):
        ...
        self.cat_all_list = ['02691156','02933112','02958343','03001627','03636649','04256520','04379243','04530566']
        self.cat_map = {
            'plane':'02691156',
            'bench': '02828884',
            'cabinet':'02933112',
        ...
        for key in self.filelist:
            ...
            if category !='all':
                ...
                qoo = False
                for i in range(len(self.cat_all_list)):
                    if key.split('/')[0] == self.cat_all_list[i]:
                        qoo = True
                if qoo == False:
                    continue
    ...
    def __getitem__(self, idx):
        ...
        # pc_path = os.path.join(self.gt_path, key.replace('\n', '')) + '.dat'
        ...
        if self.view_align:
            ...
            ran_i = random.randint(0,23)
            ran_key = key[:-3]+str(ran_i).rjust(2,'0')
